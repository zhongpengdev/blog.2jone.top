...
在代码编写方面，我进一步加深了对 **Vue3 父子组件通信机制** 的理解，明确了父组件与子组件之间通过 `defineProps` 和 `emit 信号机制` 实现数据与事件传递。这一点与我在之前的 [PyQt 项目](https://github.com/lavanceeee/Michelson-Fringe-Counting-python)
